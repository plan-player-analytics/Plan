...
import com.djrapitops.plan.system.info.connection.VelocityConnectionSystem;
...
/**
 * InfoSystem for Velocity.
 *
 * Based on BungeeInfoSystem
 *
 * @author MicleBrick
 */
public class VelocityInfoSystem extends InfoSystem {

    public VelocityInfoSystem() {
        super(new VelocityConnectionSystem());
    }
