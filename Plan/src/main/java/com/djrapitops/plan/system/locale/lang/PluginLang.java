...
public enum PluginLang implements Lang {
    ...
    ENABLED_WEBSERVER("Enable - WebServer", "Webserver running on PORT ${0} (${1})"),
    ...
    ENABLE_NOTIFY_WEBSERVER_DISABLED("Enable - Notify Webserver disabled", "WebServer was not initialized. (WebServer.DisableWebServer: true)"),
    ...
    DISABLED_WEBSERVER("Disable - WebServer", "Webserver has been disabled.");
