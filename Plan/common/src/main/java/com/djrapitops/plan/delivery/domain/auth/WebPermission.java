...
public enum WebPermission implements Supplier<String>, Lang {
    ...
    PAGE_NETWORK_STATISTICS("See Statistics -tab"),
    PAGE_NETWORK_STATISTICS_AGGREGATE("See Statistics -tab aggregated statistics"),
    PAGE_NETWORK_STATISTICS_BY_SERVER("See Statistics -tab statistics grouped by server"),
    ...
    PAGE_SERVER_STATISTICS("See Statistics -tab"),
    ...
    PAGE_PLAYER_STATISTICS("See Statistics -tab"),
    ...
    DATA_SERVER_UPTIME("See Uptime datapoint of servers"),
    DATA_NETWORK_UPTIME("See Uptime datapoint of network"),
    ...
    DATA_SERVER_DISK_MAX("See Maximum Free Disk -datapoint of servers"),
    DATA_SERVER_DISK_MIN("See Minimum Free Disk -datapoint of servers"),
    ...
    DATA_NETWORK_MSPT_AVERAGE("See Average MSPT -datapoint of network"),
    DATA_SERVER_MSPT_JITTER_AVERAGE("See MSPT Jitter Average -datapoint of servers"),
    DATA_NETWORK_MSPT_JITTER_AVERAGE("See MSPT Jitter Average -datapoint of network"),
    DATA_SERVER_MSPT_JITTER_MAX("See Max MSPT Jitter -datapoint of servers"),
    DATA_NETWORK_MSPT_JITTER_MAX("See Max MSPT Jitter -datapoint of network"),
    DATA_SERVER_MSPT_AVERAGE_LOW_TPS("See Average MSPT with Low TPS -datapoint of servers"),
    DATA_NETWORK_MSPT_AVERAGE_LOW_TPS("See Average MSPT with Low TPS -datapoint of network"),
    DATA_SERVER_MSPT_MAX_95TH("See Max 95th percentile MSPT -datapoint of servers"),
    DATA_NETWORK_MSPT_MAX_95TH("See Max 95th percentile MSPT -datapoint of network"),
    DATA_SERVER_MSPT_MAX_95TH_LOW_TPS("See Max 95th percentile MSPT with Low TPS -datapoint of servers"),
    DATA_NETWORK_MSPT_MAX_95TH_LOW_TPS("See Max 95th percentile MSPT with Low TPS -datapoint of network"),
    ...
    DATA_NETWORK_ENTITIES_AVERAGE("See Average Entities -datapoint of network"),
    DATA_SERVER_CHUNKS_AVERAGE("See Average Chunks -datapoint of servers"),
    DATA_NETWORK_CHUNKS_AVERAGE("See Average Chunks -datapoint of network"),
    DATA_SERVER_MSPT_IMPACT_PER_PLAYER("See Average MSPT impact per player -datapoint of servers"),
    DATA_NETWORK_MSPT_IMPACT_PER_PLAYER("See Average MSPT impact per player -datapoint of network"),
    DATA_SERVER_CPU_IMPACT_PER_PLAYER("See Average CPU impact per player -datapoint of servers"),
    DATA_NETWORK_CPU_IMPACT_PER_PLAYER("See Average CPU impact per player -datapoint of network"),
    DATA_SERVER_CHUNKS_PER_PLAYER("See Average Chunks per player -datapoint of servers"),
    DATA_NETWORK_CHUNKS_PER_PLAYER("See Average Chunks per player -datapoint of network"),
    DATA_SERVER_ENTITIES_PER_CHUNK("See Average Entities per Chunk -datapoint of servers"),
    DATA_NETWORK_ENTITIES_PER_CHUNK("See Average Entities per Chunk -datapoint of network"),
    DATA_SERVER_MSPT_IMPACT_PER_CHUNK("See Average MSPT impact per Chunk -datapoint of servers"),
    DATA_NETWORK_MSPT_IMPACT_PER_CHUNK("See Average MSPT impact per Chunk -datapoint of network"),
