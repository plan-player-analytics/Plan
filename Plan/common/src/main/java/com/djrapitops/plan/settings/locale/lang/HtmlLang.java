...
public enum HtmlLang implements Lang {
    ...
    SIDE_OVERVIEW("html.sidebar.overview", "Overview"),
    ...
    TITLE_GRAPH_NETWORK_ONLINE_ACTIVITY("html.title.graph.networkOnlineActivity", "Network Online Activity"),
    TITLE_GRAPH_DAY_BY_DAY("html.title.graph.dayByDay", "Day by Day"),
    TITLE_GRAPH_HOUR_BY_HOUR("html.title.graph.hourByHour", "Hour by Hour"),
    UNIT_THE_PLAYERS("html.unit.players", "Players"),
    TITLE_LAST_24_HOURS("html.title.last24hours", "Last 24 hours"),
    TITLE_LAST_7_DAYS("html.title.last7days", "Last 7 days"),
    TITLE_LAST_30_DAYS("html.title.last30days", "Last 30 days"),
    ...
    TITLE_NETWORK_AS_NUMBERS("html.title.networkAsNumbers", "Network as Numbers"),
    ...
    TITLE_WEEK_COMPARISON("html.title.weekComparison", "Week Comparison"),
    TITLE_TRENDS("html.title.trends30days", "Trends for 30 days"),
    TITLE_TREND("html.title.trend", "Trend"),
    COMPARING_7_DAYS("html.label.comparing7days", "Comparing 7 days"),
    // Servers tab
    TITLE_ONLINE_ACTIVITY("html.title.onlineActivity", "Online Activity"),
    TITLE_30_DAYS("html.title.thirtyDays", "30 days"),
    TITLE_AS_NUMBERS("html.title.asNumbers", "as Numbers"),
    ...
    TITLE_RECENT_SESSIONS("html.title.recentSessions", "Recent Sessions"),
    TITLE_PLAYER("html.title.player", "Player"),
    TITLE_SESSION_START("html.title.sessionStart", "Session Started"),
    TITLE_LENGTH("html.title.length", " Length"),
    TITLE_SERVER("html.title.server", "Server"), // Can cause issue with datatables.js
    TITLE_MOST_PLAYED_WORLD("html.title.mostPlayedWorld", "Most played World"),
    TEXT_CLICK_TO_EXPAND("html.text.clickToExpand", "Click to expand"),
    TITLE_SERVER_PLAYTIME_30("html.title.serverPlaytime30days", "Server Playtime for 30 days"),
    TITLE_INSIGHTS("html.title.insights30days", "Insights for 30 days"),
    ...
    TITLE_30_DAYS_AGO("html.title.thirtyDaysAgo", "30 days ago"),
    TITLE_NOW("html.title.now", "Now"),
    ...
    SIDE_TO_MAIN_PAGE("html.sidebar.toMainPage", "to main page"),
    // Geolocations tab
    TITLE_CONNECTION_INFO("html.title.connectionInfo", "Connection Information"),
    TITLE_COUNTRY("html.title.country", "Country"),
    TITLE_AVG_PING("html.title.averagePing", "Average Ping"),
    TITLE_WORST_PING("html.title.worstPing", "Worst Ping"),
    TITLE_BEST_PING("html.title.bestPing", "Best Ping"),
    ...
    TITLE_ONLINE_ACTIVITY_AS_NUMBERS("html.title.onlineActivityAsNumbers", "Online Activity as Numbers"),
    COMPARING_15_DAYS("html.text.comparing15days", "Comparing 15 days"),
    TITLE_GRAPH_PUNCHCARD("html.title.punchcard30days", "Punchcard for 30 Days"),
    ...
    TITLE_PVP_PVE_NUMBERS("html.title.pvpPveAsNumbers", "PvP & PvE as Numbers"),
    ...
    TITLE_RECENT_KILLS("html.title.recentKills", "Recent Kills"),
    TITLE_ALL("html.title.all", "All"),
    TITLE_TPS("html.title.tps", "TPS"),
    TITLE_CPU_RAM("html.title.cpuRam", "CPU & RAM"),
    TITLE_WORLD("html.title.world", "World Load"),
    TITLE_PING("html.title.ping", "Ping"),
    TITLE_DISK("html.title.disk", "Disk Space"),
    LABEL_AVG("html.label.average", "Average"),
    TITLE_PERFORMANCE_AS_NUMBERS("html.title.performanceAsNumbers", "Performance as Numbers"),
    ...
    // Player Page
    TITLE_SEEN_NICKNAMES("html.title.seenNicknames", "Seen Nicknames"),
    ...
    TITLE_PVP_KILLS("html.title.recentPvpKills", "Recent PvP Kills"),
    TITLE_PVP_DEATHS("html.title.recentPvpDeaths", "Recent PvP Deaths"),
    TITLE_SERVER_PLAYTIME("html.title.serverPlaytime", "Server Playtime"),
    LINK_BACK_SERVER("html.sidebar.serverPage", "Server page"),
    SIDE_SERVERS_TITLE("html.sidebar.serversTitle", "SERVERS"),
    // Were missing
    TITLE_SERVER_OVERVIEW("html.title.serverOverview", "Server Overview"),
    TITLE_ONLINE_ACTIVITY_OVERVIEW("html.title.playersOnlineOverview", "Online Activity Overview"),
    PER_DAY("html.label.perDay", "/ Day"),
    TITLE_WORLD_PLAYTIME("html.title.worldPlaytime", "World Playtime"),
    TITLE_PLAYER_OVERVIEW("html.title.playerOverview", "Player Overview"),
    ...
    // OLD
    // ----------------------------------
    NAV_PLUGINS("html.side.plugins", "Plugins"),
    ...
    TITLE_CALENDAR("html.title.calendar", " Calendar"),
