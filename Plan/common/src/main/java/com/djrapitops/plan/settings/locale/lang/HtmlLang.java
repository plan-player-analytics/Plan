...
public enum HtmlLang implements Lang {
    ...
    LABEL_CPU_IMPACT_PER_PLAYER("html.label.cpuImpactPerPlayer", "CPU impact per Player"),
    ...
    LABEL_AVG_ENTITIES_PER_CHUNK("html.label.averageEntitiesPerChunk", "Average Entities per Chunk"),
    LABEL_AVG_CHUNKS("html.label.averageChunks", "Average Chunks"),
    LABEL_AVG_CHUNKS_PER_PLAYER("html.label.averageChunksPerPlayer", "Average Chunks per Player"),
    LABEL_LOW_TPS("html.label.lowTpsSpikes", "Low TPS Spikes"),
    LABEL_LOW_TPS_MSPT_AVERAGE("html.label.averageMsptLowTPS", "Average MSPT during Low TPS"),
    LABEL_LOW_TPS_MSPT_MAX("html.label.maxMsptLowTPS", "Max 95th Percentile MSPT during Low TPS"),
    ...
    LABEL_MSPT_IMPACT_PER_PLAYER("html.label.msptImpactPlayer", "MSPT impact per Player"),
    LABEL_MSPT_IMPACT_PER_CHUNK("html.label.msptImpactChunk", "MSPT impact per Chunk"),
    ...
    HELP_PERFORMANCE_TITLE("html.label.help.performance.title", "Performance metrics explained"),
    HELP_PERFORMANCE_METRIC("html.label.help.performance.metric", "Metric"),
    HELP_PERFORMANCE_EXPLANATION("html.label.help.performance.explanation", "Explanation"),
    HELP_PERFORMANCE_DESC_1("html.label.help.performance.desc-1", "Performance metrics are gathered via a task that runs once per second, and then stored once per minute."),
    HELP_PERFORMANCE_DESC_2("html.label.help.performance.desc-2", "Some metrics are computed async to avoid impact to tick speed."),
    HELP_PERFORMANCE_SERVER_DOWNTIME("html.label.help.performance.serverDowntime", "Sum of the gaps when Plan has not recorded data. Begins from first datapoint before the gap within timeframe. If data gathering ends abruptly, the gap is not counted until next datapoint arrives."),
    HELP_PERFORMANCE_SERVER_UPTIME("html.label.help.performance.serverUptime", "Sum of sections of time when Plan has recorded data. Begins from first datapoint available within timeframe."),
    HELP_PERFORMANCE_PLAYERS_ONLINE("html.label.help.performance.playersOnline", "Graph value is maximum observed within the minute."),
    HELP_PERFORMANCE_TPS("html.label.help.performance.tps", "Game ticks per second. Minecraft runs at 20 ticks per second. Graph value is smallest value observed within the minute. Values higher than 20 can mean overticking where server is catching up previous ticks."),
    HELP_PERFORMANCE_LOW_TPS_SPIKES("html.label.help.performance.lowTpsSpikes", "When recorded TPS value is below Display_options.Graphs.TPS.Medium_threshold it is counted as Low TPS. Spike-count only increases when recorded value has returned above threshold."),
    HELP_PERFORMANCE_MSPT("html.label.help.performance.mspt", "Milliseconds per tick. When a game tick takes over 50 milliseconds it is perceived as lag. Minecraft server computes nanoseconds of each tick. Plan stores the average and 95th percentile once per minute."),
    HELP_PERFORMANCE_MSPT_PERCENTILE("html.label.help.performance.msptPercentile", "95th percentile means 95% of values are below this value. It is a sort of maximum that rules out outliers."),
    HELP_PERFORMANCE_MSPT_JITTER_AVERAGE("html.label.help.performance.msptJitterAverage", "Jitter describes how much value changed between subsequent ticks. Lower means more stable tick rate. MSPT of 35, 36, 34, 80, 37 -> Jitter = 1, 2, 46, 43 -> Average=23. Average is used to avoid needing to store 1200 values per minute."),
    HELP_PERFORMANCE_MSPT_JITTER_MAX("html.label.help.performance.msptJitterMax", "Max Jitter takes the largest subsequent tick change. Higher means a potential lag spike occurred. MSPT of 35, 36, 34, 80, 37 -> Jitter = 1, 2, 46, 43 -> Max=46"),
    HELP_PERFORMANCE_MSPT_IMPACT_PLAYER("html.label.help.performance.msptImpactPlayer", "Average MSPT / Players online."),
    HELP_PERFORMANCE_MSPT_IMPACT_CHUNK("html.label.help.performance.msptImpactChunk", "Average MSPT / Loaded chunks."),
    HELP_PERFORMANCE_ENTITIES("html.label.help.performance.entities", "Biggest observed number of entities existing at one moment during a minute. Some servers unload chunks and entities without players."),
    HELP_PERFORMANCE_LOADED_CHUNKS("html.label.help.performance.loadedChunks", "Biggest observed number of chunks loaded at one moment during a minute. Some servers unload chunks and entities without players. Not available on Sponge servers due to performance impact."),
    HELP_PERFORMANCE_CPU("html.label.help.performance.cpu", "Biggest observed value reported by Java during the minute."),
    HELP_PERFORMANCE_CPU_IMPACT_PER_PLAYER("html.label.help.performance.cpuImpactPerPlayer", "(Average CPU usage while active - Average CPU usage while idle) / Players online"),
    HELP_PERFORMANCE_RAM("html.label.help.performance.ram", "Biggest observed value reported by Java during the minute."),
    HELP_PERFORMANCE_DISK_SPACE("html.label.help.performance.diskSpace", "Smallest observed value reported by Java during the minute."),
    HELP_PERFORMANCE_MIN_FREE_DISK("html.label.help.performance.minFreeDisk", "Smallest disk space recorded by Plan within timeframe."),
    HELP_PERFORMANCE_MAX_FREE_DISK("html.label.help.performance.maxFreeDisk", "Biggest disk space recorded by Plan within timeframe."),
    HELP_PERFORMANCE_PING("html.label.help.performance.ping", "Delay measured by Minecraft server between packets being sent and received by the game client. The task runs every 2 seconds, and Min/Max/Average is gathered from each player separately once per minute. There are some delays in the config (Ping_server_enable_delay - default 10 minutes, Ping_player_join_delay - default 30 seconds) which filter out garbage data from being recorded."),
