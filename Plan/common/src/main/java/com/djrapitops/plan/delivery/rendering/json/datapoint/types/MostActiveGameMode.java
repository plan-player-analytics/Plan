 ...
 */
@Singleton
public class MostActiveGameMode implements Datapoint<OutOfCategory> {
    ...
    public DatapointType getType() {
        return DatapointType.MOST_ACTIVE_GAME_MODE;
    }
    ...
    public Optional<OutOfCategory> getValue(GenericFilter filter) {
        ...
        return Optional.of(new OutOfCategory(worldTimes.computeGMTimes(), worldTimes.getTotal()));
    }
}
