...
public enum HelpLang implements Lang {
    ...
    ARG_AFTER_DATE("command.argument.afterDate.name", "CMD Arg Name - after date", "after-date"),
    ARG_BEFORE_DATE("command.argument.beforeDate.name", "CMD Arg Name - before date", "before-date"),
    ...
    DESC_ARG_AFTER_DATE("command.argument.afterDate.description", "CMD Arg - after date", "First registration date to remove, formatted yyyy-MM-dd"),
    DESC_ARG_BEFORE_DATE("command.argument.beforeDate.description", "CMD Arg - before date", "Last registration date to remove, formatted yyyy-MM-dd"),
    ...
    DB_REMOVE_REGISTERED("command.help.dbRemoveRegistered.description", "Command Help - /plan db remove_registered", "Remove players registered in a date range"),
