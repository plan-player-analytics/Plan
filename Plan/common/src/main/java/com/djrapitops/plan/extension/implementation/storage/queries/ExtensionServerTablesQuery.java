...
/**
 * Query server tables from server tableprovider table.
 * <p>
...
public class ExtensionServerTablesQuery implements Query<Map<Integer, ExtensionServerData.Factory>> {
    ...
    private Query<Map<Integer, Map<Integer, Table.Factory>>> queryTableProviders() {
        String selectTables = SELECT +
                ...
                "e1." + ExtensionTableProviderTable.PROVIDER_NAME + " as table_name," +
                ...
                INNER_JOIN + ExtensionPluginTable.TABLE_NAME + " e1 on e1." + ExtensionPluginTable.ID + "=p1." + ExtensionTableProviderTable.PLUGIN_ID +
