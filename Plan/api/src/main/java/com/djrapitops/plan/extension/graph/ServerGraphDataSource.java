...
/**
 * Return value for Server/Network graph from {@link com.djrapitops.plan.extension.annotation.GraphProvider} annotated method.
 *
 * @author AuroraLS3
 */
public abstract class ServerGraphDataSource {
    /**
     ...
     */
    public abstract Optional<DataPoint> getPoint(long currentTimestamp);

    /**
     * Override this method to return point history for your data.
     * <p>
     * History data method is called along with other server extension methods.
     * <p>
     * Only return history if necessary and not too much at once to avoid server running out of memory.
     *
     * @param currentTimestamp Epoch millisecond of method call time.
