...
/**
 * Return value for Group graph from {@link com.djrapitops.plan.extension.annotation.GraphProvider} annotated method.
 *
 * @author AuroraLS3
 */
public abstract class GroupGraphDataSource {
    /**
     ...
     */
    public abstract Optional<DataPoint> getPoint(long currentTimestamp, String groupName);
     ...
     */
    public List<DataPoint> getPointHistory(long currentTimestamp, String groupName) {
