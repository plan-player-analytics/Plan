...
const PlayerPvpPveAsNumbersTable = ({killData}) => {
    ...
    return (
        ...
        >
            <TableRow icon={faCrosshairs} color="player-kills" text={t('html.label.kdr')} bold
            ...
            <TableRow icon={faSkull} color="player-kills" text={t('html.label.playerDeaths')}
                      values={[killData.player_deaths_total,
                          killData.player_deaths_30d,
                          killData.player_deaths_7d]}/>
            <TableRow icon={faCrosshairs} color="mob-kills" text={t('html.label.mobKdr')} bold
