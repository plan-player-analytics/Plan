...
/**
 * System for checking if new Version is available when the System initializes, altering the link for NeoForge.
 */
@Singleton
    ...
    public Optional<VersionInfo> getNewVersionAvailable() {
        if (newVersionAvailable == null) {
            ...
            return Optional.of(new VersionInfo(
                    ...
                    newVersionAvailable.getDownloadUrl().replace("Plan-", "PlanNeoForge-"),
