...
public class NeoForgePlatformLayer implements PlatformAbstractionLayer {
    ...
    public NeoForgePlatformLayer(PlanNeoForge plugin) {
        this.plugin = plugin;
    }
    ...
    public PluginInformation getPluginInformation() {
        if (this.pluginInformation == null) {
            this.pluginInformation = new NeoForgePluginInformation(this.plugin);
        }
