package com.djrapitops.plan.sponge.info;

import com.djrapitops.plan.api.exceptions.EnableException;
import com.djrapitops.plan.api.exceptions.database.DBOpException;
import com.djrapitops.plan.sponge.info.server.SpongeServerProperties;
...
public class SpongeServerInfo extends ServerInfo {
    private ServerInfoFile serverInfoFile;
    private Database database;

    public SpongeServerInfo() {
        this(new SpongeServerProperties(Sponge.getGame()));
    }

    public SpongeServerInfo(ServerProperties serverProperties) {
